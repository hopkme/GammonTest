...
function roll() {
	...
	if (GameState.player1Turn) {
		if (GameState.initialPlayer1Roll1 == 0)  {
			die1.rigidbody.mass = 8;
			die1.rigidbody.AddForce(Random.Range(-180,-140),Random.Range(-20,-30),Random.Range(-20,-5),ForceMode.Impulse);
			die1.rigidbody.AddTorque(Random.Range(-15,-20),Random.Range(3,-20),Random.Range(-4,4),ForceMode.Impulse);
		}
		if ((!GameState.rollForTurn) || (GameState.initialPlayer1Roll1 > 0)) {
			die2.rigidbody.mass = 8;
			die2.rigidbody.AddForce(Random.Range(-180,-140),Random.Range(-20,-30),Random.Range(-20,-5),ForceMode.Impulse);
